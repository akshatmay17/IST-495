...
function Goals({ goals, onAdd, onUpdateProgress, onDelete, profile }: { goals:Goal[]; onAdd:(g:Omit<Goal,"id">)=>void; onUpdateProgress:(id:string,current:number)=>void; onDelete:(id:string)=>void; profile:UserProfile }) {
  ...
  const getJobs = () => {
    ...
    const market = [
      // — LINKEDIN & MAJOR JOB BOARDS —
      {title:"Jobs on LinkedIn",company:"LinkedIn",type:"remote",pay:"Varies",payLow:15,payHigh:40,hours:"Part or full-time",tags:["Remote","On-site","All levels"],link:`https://www.linkedin.com/jobs/search/?keywords=part+time&location=${encodeURIComponent(location)}`,source:"LinkedIn",verified:true,desc:"Search thousands of jobs filtered by location, remote, experience level. Apply with your LinkedIn profile instantly."},
      {title:"Part-Time Jobs",company:"Indeed",type:"part-time",pay:"$12–20/hr",payLow:12,payHigh:20,hours:"15–30 hrs/week",tags:["Part-time","Local","All levels"],link:`https://www.indeed.com/jobs?q=part+time&l=${encodeURIComponent(location)}`,source:"Indeed",verified:true,desc:"Largest job board. Filter by part-time, salary range, remote, and distance. New listings daily."},
      {title:"Entry-Level Jobs",company:"Glassdoor",type:"part-time",pay:"$13–22/hr",payLow:13,payHigh:22,hours:"Varies",tags:["Entry-level","Reviews","Salary data"],link:`https://www.glassdoor.com/Job/state-college-part-time-jobs-SRCH_IL.0,13_IC1152543_KO14,23.htm`,source:"Glassdoor",verified:true,desc:"Job listings with company reviews and salary transparency. Know what you're getting into before applying."},
      {title:"Quick-Hire Jobs",company:"ZipRecruiter",type:"part-time",pay:"$12–18/hr",payLow:12,payHigh:18,hours:"Varies",tags:["Quick apply","Local","Part-time"],link:`https://www.ziprecruiter.com/jobs-search?search=part+time&location=${encodeURIComponent(location)}`,source:"ZipRecruiter",verified:true,desc:"One-click apply to multiple jobs. AI matches your profile to openings. Get notified when employers view your application."},
      {title:"Jobs Near You",company:"Snagajob",type:"part-time",pay:"$11–16/hr",payLow:11,payHigh:16,hours:"10–30 hrs/week",tags:["Hourly","Local","No experience"],link:"https://www.snagajob.com/jobs",source:"Snagajob",verified:true,desc:"Specializes in hourly and shift work. Restaurants, retail, hospitality. Perfect for flexible schedules."},

      // — REMOTE-ONLY PLATFORMS —
      {title:"Remote Jobs",company:"We Work Remotely",type:"remote",pay:"$20–60/hr",payLow:20,payHigh:60,hours:"Part or full-time",tags:["Remote only","Tech","Global"],link:"https://weworkremotely.com/",source:"We Work Remotely",verified:true,desc:"Largest remote work community. Programming, design, marketing, customer support. All jobs are 100% remote."},
      {title:"Remote & Flexible Jobs",company:"FlexJobs",type:"remote",pay:"$15–45/hr",payLow:15,payHigh:45,hours:"Flexible",tags:["Remote","Vetted","Flexible"],link:"https://www.flexjobs.com/",source:"FlexJobs",verified:true,desc:"Hand-screened remote and flexible jobs. Every listing verified — no scams. Paid membership but high quality."},
      {title:"Remote Part-Time",company:"Remote.co",type:"remote",pay:"$18–40/hr",payLow:18,payHigh:40,hours:"Part-time",tags:["Remote","Curated","Professional"],link:"https://remote.co/remote-jobs/",source:"Remote.co",verified:true,desc:"Curated remote positions from vetted companies. Filtered by category, level, and job type."},

      // — FREELANCE PLATFORMS —
      {title:"Freelance on Upwork",company:"Upwork",type:"remote",pay:"$15–50/hr",payLow:15,payHigh:50,hours:"Flexible",tags:["Remote","Freelance","Flexible"],link:"https://www.upwork.com/freelance-jobs/",source:"Upwork",verified:true,desc:"Data entry, writing, design, development, virtual assistance. Set your own rate and hours. Build a client base."},
      {title:"Fiverr Freelancing",company:"Fiverr",type:"remote",pay:"$10–100/gig",payLow:10,payHigh:50,hours:"Per project",tags:["Remote","Freelance","Skill-based"],link:"https://www.fiverr.com/start_selling",source:"Fiverr",verified:true,desc:"Sell services: graphic design, writing, video editing, social media. Create gigs and attract buyers."},
      {title:"Freelance Writing & More",company:"Freelancer",type:"remote",pay:"$10–40/hr",payLow:10,payHigh:40,hours:"Per project",tags:["Remote","Freelance","Bidding"],link:"https://www.freelancer.com/jobs/",source:"Freelancer",verified:true,desc:"Bid on projects in writing, design, data entry, programming. Compete with other freelancers for gigs."},
      {title:"Tutoring",company:"Wyzant",type:"remote",pay:"$20–40/hr",payLow:20,payHigh:40,hours:"Flexible",tags:["Remote","Skill-based","High pay"],link:"https://www.wyzant.com/tutorjobs",source:"Wyzant",verified:true,desc:"Tutor students in subjects you know well. Set your own schedule and rates. High demand for STEM."},

      // — GIG ECONOMY —
      {title:"Food Delivery",company:"DoorDash",type:"gig",pay:"$15–22/hr",payLow:15,payHigh:22,hours:"Flexible",tags:["Gig","Flexible","Vehicle needed"],link:"https://dasher.doordash.com/en-us",source:"DoorDash",verified:true,desc:"Deliver food orders in your area. Earnings vary by time, location, and tips."},
      {title:"Rideshare Driver",company:"Uber",type:"gig",pay:"$18–28/hr",payLow:18,payHigh:28,hours:"Flexible",tags:["Gig","Flexible","Vehicle + insurance"],link:"https://www.uber.com/us/en/drive/",source:"Uber",verified:true,desc:"Drive passengers on your schedule. Must meet vehicle and background requirements."},
      {title:"Grocery Delivery",company:"Instacart",type:"gig",pay:"$14–25/hr",payLow:14,payHigh:25,hours:"Flexible",tags:["Gig","Flexible","Vehicle helpful"],link:"https://shoppers.instacart.com/",source:"Instacart",verified:true,desc:"Shop and deliver groceries. Earn per batch. Tips can significantly increase hourly rate."},
      {title:"Task-Based Work",company:"TaskRabbit",type:"gig",pay:"$15–40/hr",payLow:15,payHigh:40,hours:"Per task",tags:["Gig","Local","Physical"],link:"https://www.taskrabbit.com/become-a-tasker",source:"TaskRabbit",verified:true,desc:"Furniture assembly, moving help, cleaning, handyman work. Set your rates and availability."},

      // — MICRO / EASY START —
      {title:"User Testing",company:"UserTesting",type:"remote",pay:"$10/test",payLow:10,payHigh:60,hours:"Flexible",tags:["Remote","No experience","Quick tasks"],link:"https://www.usertesting.com/get-paid-to-test",source:"UserTesting",verified:true,desc:"Test websites and apps, share opinions. Each test 15–20 min at $10. Quick to start."},
      {title:"Research Studies",company:"Prolific",type:"remote",pay:"$8–15/hr",payLow:8,payHigh:15,hours:"Flexible",tags:["Remote","No experience","Academic"],link:"https://www.prolific.com/participants",source:"Prolific",verified:true,desc:"Participate in academic research studies. Better pay than typical survey sites."},
      {title:"Virtual Assistant",company:"Belay",type:"remote",pay:"$15–25/hr",payLow:15,payHigh:25,hours:"10–30 hrs/week",tags:["Remote","Part-time","Organized"],link:"https://belaysolutions.com/join-our-team/",source:"Belay",verified:true,desc:"Email management, scheduling, data entry, customer service. Work from home for U.S. businesses."},

      // — STARTUP / TECH —
      {title:"Startup Jobs",company:"Wellfound",type:"remote",pay:"$18–50/hr",payLow:18,payHigh:50,hours:"Part or full-time",tags:["Startup","Equity","Tech"],link:"https://wellfound.com/jobs",source:"Wellfound",verified:true,desc:"Jobs at startups — some offer equity. Engineering, design, marketing, sales. Filter by remote and part-time."},
    ];

    if (jobStatus === "unemployed") {
      market.push(
        {title:"Full-Time Search",company:"LinkedIn",type:"full-time",pay:"Market rate",payLow:20,payHigh:50,hours:"Full-time",tags:["Full-time","Career","Benefits"],link:"https://www.linkedin.com/jobs/",source:"LinkedIn",verified:true,desc:"Full-time positions matched to your skills and experience. Set up job alerts for instant notifications."},
        {title:"Temp/Contract Work",company:"Robert Half",type:"part-time",pay:"$18–35/hr",payLow:18,payHigh:35,hours:"Full or part-time",tags:["Temp","Contract","Quick start"],link:"https://www.roberthalf.com/us/en/job-seekers",source:"Robert Half",verified:true,desc:"Temporary and contract positions that start quickly while you search for permanent roles."},
        {title:"Government Jobs",company:"USAJobs",type:"full-time",pay:"GS scale",payLow:17,payHigh:40,hours:"Full-time",tags:["Government","Benefits","Stable"],link:"https://www.usajobs.gov/",source:"USAJobs",verified:true,desc:"Federal government positions with benefits, job security, and competitive pay. Filter by location and agency."},
        {title:"Non-Profit Jobs",company:"Idealist",type:"full-time",pay:"Varies",payLow:15,payHigh:35,hours:"Full or part-time",tags:["Non-profit","Mission-driven","Benefits"],link:"https://www.idealist.org/en/jobs",source:"Idealist",verified:true,desc:"Jobs at non-profits and social enterprises. If you want work that matters, start here."},
      );
    }
          ...
          <div>
            ...
            <div style={{display:"flex",gap:6,marginBottom:14,overflowX:"auto",paddingBottom:2}} className="no-scrollbar">
              {[
                ...
                {key:"gig",label:"Gig work"},{key:"remote",label:"Remote"},
